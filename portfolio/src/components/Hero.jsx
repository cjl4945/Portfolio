  ...
  return (
    ...
    mx-auto'>
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-
          [#915eff]'>Chase</span> </h1>
          <p className={`${styles.heroSubText} mt-2
          text-white-100 `}>
            I'm a recent Computer Engineer grauduate from  
            <span className='text-[#F87000]'> Rochester Institute of Technology</span> 
            &nbsp; with a diverse skillset. I created this website to grasp concepts in deploying a website using <a className=' underline' href='https://aws.amazon.com/'>AWS</a>
